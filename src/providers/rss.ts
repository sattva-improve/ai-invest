...
export async function fetchRssFeeds(options: FetchRssOptions): Promise<NewsArticle[]> {
...
async function fetchSingleFeed(url: string, maxItems: number): Promise<NewsArticle[]> {
