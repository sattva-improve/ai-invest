...
[Vercel AI SDK](https://sdk.vercel.ai/) + Google Gemini 2.5 Pro / Gemini 2.0 Flash による **Structured Output** で売買シグナルを JSON 生成し、株式・暗号資産取引所へ自動発注します。
...
|--------|----------|--------|----------|
| 🇯🇵 **日本株** | 東京証券取引所 (TSE/JPX) | au Kabucom API / IBKR | `7203.T`, `9984.T` |
...
- **Cost-Optimized AI**: 高頻度分析は Gemini 2.0 Flash、重要判断は Gemini 2.5 Pro でコストと精度を両立
...
- **AI / LLM**:
  - [Vercel AI SDK](https://sdk.vercel.ai/) (`ai` + `@ai-sdk/google`) — 軽量な Structured Output 生成
  - Google Gemini 2.5 Pro (重要判断) / Gemini 2.0 Flash (高頻度分析, コスト最適化)
...
- **Brokers**:
  - [au Kabucom API](https://kabucom.github.io/kabusapi/ptal/) — 日本株 (kabuステーション経由)
